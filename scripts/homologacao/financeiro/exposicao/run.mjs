...
const child = spawnSync(process.execPath, [resolve('node_modules/tsx/dist/cli.mjs'), resolve('scripts/homologacao/financeiro/exposicao/run-worker.ts')], {
...
if (child.status !== 0) throw new Error(`Worker P2.5 encerrou com codigo ${child.status ?? 'desconhecido'}.`)
