...
const child = spawnSync(process.execPath, [resolve('node_modules/tsx/dist/cli.mjs'), resolve('scripts/homologacao/financeiro/risco/run-worker.ts')], {
...
if (child.status !== 0) throw new Error(`Worker P2.6 encerrou com codigo ${child.status ?? 'desconhecido'}.`)
