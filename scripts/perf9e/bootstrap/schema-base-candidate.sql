-- BW Antecipa - Escopo 9E - bootstrap candidato, fora da cadeia ativa.
-- Fonte comprovada: supabase/schema.sql no commit 94e84e618fa0fbc96312441c847a37aa44afc744.
-- O mesmo commit introduziu 003_storage_buckets_env.sql e consolidou o estado
-- historico de 002_contratos.sql neste schema. Nao aplicar em ambiente remoto.
-- Este arquivo nao contem seed, usuarios, UUIDs de negocio, URLs ou secrets.
