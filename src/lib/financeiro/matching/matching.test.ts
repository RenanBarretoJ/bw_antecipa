...
import type { FinancialExternalSource, KnownCrosswalk, NoteCandidate } from '../conciliacao/types'
...
function source(overrides: Partial<FinancialExternalSource> = {}): FinancialExternalSource {
  return {
...
function note(overrides: Partial<NoteCandidate> = {}): NoteCandidate {
  return {
...
function crosswalk(overrides: Partial<KnownCrosswalk> = {}): KnownCrosswalk {
  return {
