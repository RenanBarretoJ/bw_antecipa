...
type ReconciliationInputs = {
  fundoId: string
  estoqueD2: ReconciliationRow[]
  estoqueD1: ReconciliationRow[]
  aquisicoesD1: ReconciliationRow[]
  liquidacoesD1: ReconciliationRow[]
  contexto?: ReconciliationContext
}
...
function group(rows: ReconciliationRow[]) {
...
function classify(input: {
  ...
  acquisitions: ReconciliationRow[]
  liquidations: ReconciliationRow[]
...
export function reconciliarTitulosD2D1(input: ReconciliationInputs): ReconciliationResult[] {
