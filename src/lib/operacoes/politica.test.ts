...
const policy = (): PoliticaResolvida => ({
  ...
  politica: { id: 'policy-1', fundo_id: 'fundo-1', cedente_fundo_id: null, codigo: 'POL-1', nome: 'Politica', descricao: null, status: 'ativa', padrao: true, created_by: 'user-1', created_at: '2026-01-01T00:00:00Z', updated_at: '2026-01-01T00:00:00Z' },
  versao: { id: 'version-1', politica_operacional_id: 'policy-1', fundo_id: 'fundo-1', cedente_fundo_id: null, versao: 1, status: 'publicada', vigente_desde: '2026-01-01T00:00:00Z', vigente_ate: null, aceite_sacado_obrigatorio: true, cessao_no_desembolso: true, cria_acompanhamento_entrega: false, configuracao: { limite: 100 }, regras: {}, parametros: {}, conteudo_hash: 'draft-hash', publicada_por: 'user-1', publicada_em: '2026-01-01T00:00:00Z', substituida_em: null, created_at: '2026-01-01T00:00:00Z', updated_at: '2026-01-01T00:00:00Z' },
