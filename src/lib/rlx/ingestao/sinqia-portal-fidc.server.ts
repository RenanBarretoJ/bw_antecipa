...
import type { RlxCapabilityHandler, RlxCapabilityRequest } from './provider'
...
export function createSinqiaPortalFidcFinancialHandlers(dependencies: Dependencies = {}): RlxCapabilityHandler[] {
