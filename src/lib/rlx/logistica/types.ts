...
export const RLX_LOGISTICS_RULE_VERSION = 'RLX_LOGISTICA_V1' as const

export type RlxLogisticsLinkStatus = 'MATCHED_FINANCEIRO_NF' | 'SEM_MATCH_FINANCEIRO_NF'

export type RlxLogisticsSnapshotRow = {
  ...
  statusVinculo: RlxLogisticsLinkStatus
