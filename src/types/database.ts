...
export interface Database {
  public: {
    ...
    Functions: {
      ...
      excluir_notas_fiscais_rascunho_operador: { Args: { p_nota_fiscal_ids: string[]; p_cedente_id: string }; Returns: { ids_excluidos: string[]; total_excluido: number; storage_objects: Array<{ bucket: string; path: string }> } }
