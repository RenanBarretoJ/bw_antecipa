...
const statusConfig: Record<string, { label: string; icon: typeof CheckCircle; variant: 'default' | 'secondary' | 'destructive' | 'outline'; className: string }> = {
  ...
  aprovada: { label: 'Validada', icon: CheckCircle, variant: 'default', className: 'bg-green-100 text-green-700 border-transparent' },
  ...
  aceita: { label: 'Aprovado pelo Sacado', icon: CheckCircle, variant: 'default', className: 'bg-green-100 text-green-700 border-transparent' },
  contestada: { label: 'Contestada', icon: AlertCircle, variant: 'destructive', className: 'bg-orange-100 text-orange-700 border-transparent' },
