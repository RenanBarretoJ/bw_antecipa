...
import { gerarNotificacaoCessao } from '@/lib/pdf/gerarContrato'
...
export async function POST(req: NextRequest) {
  try {
    ...
    const { url, path } = await gerarNotificacaoCessao(operacao_id, context.user.id)
    ...
    console.error('[api/contratos/gerar-notificacao]', message)
