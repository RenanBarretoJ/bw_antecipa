...
const statusConfig: Record<string, { label: string; variant: 'default' | 'secondary' | 'destructive' | 'outline'; className: string; icon: typeof CheckCircle }> = {
  ...
  aceita:        { label: 'Aceito pelo Sacado', variant: 'secondary',   className: 'bg-green-100 text-green-700 border-green-200',     icon: CheckCircle },
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <div className="relative">
              ...
              >
                ...
                <option value="aceita">Aceito pelo Sacado</option>
