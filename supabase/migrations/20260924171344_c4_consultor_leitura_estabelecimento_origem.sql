-- C4 follow-up: o Consultor precisa enxergar apenas os estabelecimentos dos
-- Cedentes que pode operar e que compartilham um fundo ativo autorizado.
...
BEGIN
  IF to_regprocedure('private.usuario_pode_operar_cedente(uuid)') IS NULL
    ...
    RAISE EXCEPTION 'Pre-condicoes C2/C3 ausentes para a leitura C4 de estabelecimentos';
  END IF;
END;
$$;
