-- P8.0: operacoes_nfs preserva o historico. O aceite considera somente
-- operacoes cujo vinculo ainda e operacional (nao canceladas/reprovadas).
-- A RPC e a fonte transacional do aceite; nao remover vinculos antigos.
